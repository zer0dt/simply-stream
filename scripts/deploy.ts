...
import { SimplyStream } from '../src/contracts/simplyStream'
...
async function main() {
    ...
    const instance = new SimplyStream(
    ...
    console.log('SimplyStream contract was successfully deployed!')
